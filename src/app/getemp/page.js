          ...
          <table className="min-w-[800px] bg-white border border-gray-200 rounded-lg shadow-sm ">
            <thead>
              <tr className="bg-gray-100 text-left text-sm font-semibold text-gray-700 ">
                ...
                <th className="py-4 px-4 border-b">Gender</th>
                <th className="py-4 px-4 border-b">Department</th>
                <th className="py-4 px-4 border-b">Position</th>
            ...
            <tbody>
              {data.map((emp, index) => (
                <tr key={index} className="hover:bg-gray-100 text-sm">
                  <td className="py-4 px-4 border-b font-semibold">{emp.name}</td>
                  <td className="py-4 px-4 border-b">{emp.email}</td>
                  <td className="py-4 px-4 border-b">{emp.gender }</td>
                  <td className="py-4 px-4 border-b">{emp.department}</td>
                  <td className="py-4 px-4 border-b">{emp.position}</td>
